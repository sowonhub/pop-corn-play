    ...
    <form onSubmit={onSubmit} role="search" aria-label="영화 검색">
      <div className={`relative ${compact ? "" : "w-full"}`}>
        <input
          ...
          placeholder="영화 검색…"
          className={`w-full ${size} rounded-xl border border-neutral-300 bg-white pr-10 pl-9 text-neutral-900 placeholder:text-neutral-400 focus:ring-4 focus:ring-neutral-200/70 focus:outline-none dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 dark:placeholder:text-neutral-500 dark:focus:ring-neutral-800`}
          aria-label="검색어"
        />
        {/* Icon (left) */}
        <svg
